	...
	while(salir == false)
	{
		...
		for ( int i = 0; i < 39; i++)
		{
			...
			if (libroEnminuscula.find(buscar) != string::npos) {
				...
				cout << "Tambien te sugrimos estos libros: " <<endl;
				int sugerencias1 = rand() % 38 + 1;
				int sugerencias2 = rand() % 38 + 1;
				int sugerencias3 = rand() % 38 + 1;
				
				cout << " Sugerencia : " <<libros[sugerencias1][1] <<endl;
				cout << " Sugerencia : " <<libros[sugerencias2][1] <<endl;
				cout << " Sugerencia : " <<libros[sugerencias3][1] <<endl;
